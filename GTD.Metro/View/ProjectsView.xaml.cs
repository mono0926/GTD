...
namespace Mono.App.GTD.View
{
    ...
    /// </summary>
    public sealed partial class ProjectsView : Mono.App.GTD.Common.LayoutAwarePage
    {
        public ProjectsView()
        {
        ...
        public ProjectsViewModel ViewModel { get { return this.DataContext as ProjectsViewModel; } }
